...
@Component(service=Servlet.class,property = {"sling.servlet.resourceTypes=/apps/dropdownJson/data",
...
public class DropdownServlet extends SlingAllMethodsServlet {
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
		...
		Resource countryResource=resolver.getResource("/content/dam/wknd/dropdown.json");
